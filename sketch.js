...
function preload(){
  ...
  //backgroundImg = loadImage("fondov3.png")
  //sunAnimation = loadImage("assets/sun.png");
  
  trex_running = loadAnimation("tortuga.png");
  //trex_collided = loadAnimation("assets/trex_collided.png");
  
  groundImage = loadImage("fondov3.png");
...
function setup() {
  ...
  trex.setCollider('rectangle',0,0,300,200)
  trex.scale = 0.3
  trex.debug=true
...
function draw() {
  ...
  textSize(20);
  fill("black")
  text("Puntaje: "+ score,width/2+80,50);
